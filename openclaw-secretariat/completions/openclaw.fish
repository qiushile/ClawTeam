...
complete -c openclaw -n "__fish_use_subcommand" -a "qa" -d 'Run private QA automation flows and launch the QA debugger'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from broadcast" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from react" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from reactions" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from delete" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from pin" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from pins" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from permissions" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from create" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from reply" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from upload" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from info" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from timeout" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from kick" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from ban" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "run" -d 'Run the bundled QA self-check and write a Markdown report'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "suite" -d 'Run repo-backed QA scenarios against the QA gateway lane'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "character-eval" -d 'Run the character QA scenario across live models and write a judged report'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "manual" -d 'Run a one-off QA agent prompt against the selected provider/model lane'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "ui" -d 'Start the private QA debugger UI and local QA bus'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "docker-scaffold" -d 'Write a prebaked Docker scaffold for the QA dashboard + gateway lane'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "docker-build-image" -d 'Build the prebaked QA Docker image with qa-channel + qa-lab bundled'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "up" -d 'Build the QA site, start the Docker-backed QA stack, and print the QA Lab URL'
complete -c openclaw -n "__fish_seen_subcommand_from qa" -a "mock-openai" -d 'Run the local mock OpenAI Responses API server for QA'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l output -d 'Report output path'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l output-dir -d 'Suite artifact directory'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l provider-mode -d 'Provider mode: mock-openai or live-frontier (legacy live-openai still works)'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l model -d 'Primary provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l alt-model -d 'Alternate provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l scenario -d 'Run only the named QA scenario (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from suite" -l fast -d 'Enable provider fast mode where supported'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l output-dir -d 'Character eval artifact directory'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l model -d 'Provider/model ref to evaluate; options: thinking=<level>, fast, no-fast, fast=<bool>'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l scenario -d 'Character scenario id'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l fast -d 'Enable provider fast mode for all candidate runs'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l thinking -d 'Candidate thinking default: off|minimal|low|medium|high|xhigh|adaptive'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l model-thinking -d 'Deprecated: candidate thinking override for one model ref (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l judge-model -d 'Judge provider/model ref; options: thinking=<level>, fast, no-fast, fast=<bool> (repeatable)'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l judge-timeout-ms -d 'Override judge wait timeout'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l blind-judge-models -d 'Hide candidate model refs from judge prompts; reports still map rankings back to real refs'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l concurrency -d 'Candidate model run concurrency'
complete -c openclaw -n "__fish_seen_subcommand_from character-eval" -l judge-concurrency -d 'Judge model run concurrency'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l message -d 'Prompt to send to the QA agent'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l provider-mode -d 'Provider mode: mock-openai or live-frontier (legacy live-openai still works)'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l model -d 'Primary provider/model ref (defaults by provider mode)'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l alt-model -d 'Alternate provider/model ref'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l fast -d 'Enable provider fast mode where supported'
complete -c openclaw -n "__fish_seen_subcommand_from manual" -l timeout-ms -d 'Override agent.wait timeout'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l host -d 'Bind host'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l port -d 'Bind port'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l advertise-host -d 'Optional public host to advertise in bootstrap payloads'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l advertise-port -d 'Optional public port to advertise'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l control-ui-url -d 'Optional Control UI URL to embed beside the QA panel'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l control-ui-token -d 'Optional Control UI token for embedded links'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l control-ui-proxy-target -d 'Optional upstream Control UI target for /control-ui proxying'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l ui-dist-dir -d 'Optional QA Lab UI asset directory override'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l auto-kickoff-target -d 'Kickoff default target (direct or channel)'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l embedded-gateway -d 'Embedded gateway mode hint'
complete -c openclaw -n "__fish_seen_subcommand_from ui" -l send-kickoff-on-start -d 'Inject the repo-backed kickoff task when the UI starts'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l output-dir -d 'Output directory for docker-compose + state files'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l gateway-port -d 'Gateway host port'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l qa-lab-port -d 'QA lab host port'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l provider-base-url -d 'Provider base URL for the QA gateway'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l image -d 'Prebaked image name'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l use-prebuilt-image -d 'Use image: instead of build: in docker-compose'
complete -c openclaw -n "__fish_seen_subcommand_from docker-scaffold" -l bind-ui-dist -d 'Bind-mount extensions/qa-lab/web/dist into the qa-lab container for faster UI refresh'
complete -c openclaw -n "__fish_seen_subcommand_from docker-build-image" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from docker-build-image" -l image -d 'Image tag'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l repo-root -d 'Repository root to target when running from a neutral cwd'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l output-dir -d 'Output directory for docker-compose + state files'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l gateway-port -d 'Gateway host port'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l qa-lab-port -d 'QA lab host port'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l provider-base-url -d 'Provider base URL for the QA gateway'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l image -d 'Image tag'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l use-prebuilt-image -d 'Use image: instead of build: in docker-compose'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l bind-ui-dist -d 'Bind-mount extensions/qa-lab/web/dist into the qa-lab container for faster UI refresh'
complete -c openclaw -n "__fish_seen_subcommand_from up" -l skip-ui-build -d 'Skip pnpm qa:lab:build before starting Docker'
complete -c openclaw -n "__fish_seen_subcommand_from mock-openai" -l host -d 'Bind host'
complete -c openclaw -n "__fish_seen_subcommand_from mock-openai" -l port -d 'Bind port'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from capabilities" -l channel -d 'Channel (all|feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from resolve" -l channel -d 'Channel (feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logs" -l channel -d 'Channel (all|feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|qa-channel|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp)'
