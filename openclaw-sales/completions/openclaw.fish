...
complete -c openclaw -n "__fish_use_subcommand" -a "ltm" -d 'LanceDB memory plugin commands'
...
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l no-ascii -d 'Skip ASCII QR rendering'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from ltm" -a "list" -d 'List memories'
complete -c openclaw -n "__fish_seen_subcommand_from ltm" -a "search" -d 'Search memories'
complete -c openclaw -n "__fish_seen_subcommand_from ltm" -a "stats" -d 'Show memory statistics'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (feishu)'
...
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (feishu)'
